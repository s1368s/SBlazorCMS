        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Categories_Skins_SkinId",
                        column: x => x.SkinId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BigImg = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SmallImg = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderValue = table.Column<int>(type: "int", nullable: false),
                    SkinId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentRevisions_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContentRevisions_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentRevisions_ContentId_LanguageId",
                table: "ContentRevisions",
                columns: new[] { "ContentId", "LanguageId" });

            migrationBuilder.CreateIndex(
                name: "IX_ContentRevisions_LanguageId",
                table: "ContentRevisions",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_Contents_SkinId",
                table: "Contents",
                column: "SkinId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentTranslations_ContentId_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentTranslations_Slug_LanguageId",
                table: "ContentTranslations",
                columns: new[] { "Slug", "LanguageId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagTranslations_Slug_LanguageId",
                table: "TagTranslations",
                columns: new[] { "Slug", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TagTranslations_TagId_LanguageId",
                table: "TagTranslations",
